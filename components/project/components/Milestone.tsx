...
function Milestone({num, title, description, isActiveNo = 1}: {num: number, title: string, description: string, isActiveNo?: number}) {
  return (
    <div className="flex flex-col justify-center items-center gap-1 w-[180px]">
