...
import Headline from "@/components/reusables/wrapper/Headline";
...
export default function MeetingsDetails() {
  ...
  return (
    <MainContainer role={ROLE}>
      <Headline title="Meetings detail">
          ...
          <TabsContent value="allMetting">
            <div className="w-full h-full flex flex-col">
              {meetingsDetails.map((details) => (
                <Card key={details.title} details={details} role={ROLE} />
              ))}
            </div>
          </TabsContent>
...
function Card({
  ...
  return (
    <div
      key={key}
      className="flex flex-row items-center justify-between w-full hover:shadow-[3px_3px_10px_0px_#789BD399,-5px_-5px_10px_0px_#FFFFFF]  p-3   "
    >
