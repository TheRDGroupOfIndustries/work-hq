          ...
          <div className=" w-full h-full flex flex-col  md:flex-row p-2 ">
            <div className="pr-3 font-normal  md:w-1/2 h-full  flex flex-col gap-1 md:border-r md:border-b-0 border-b border-[#9c9c9c]">
              <div className="w-full flex flex-col  ">
                ...
                <p className="text-base  text-[#6A6A6A]">CSK Textile</p>
              </div>
              ...
              <div className="w-full flex flex-col  ">
                ...
                <p className="text-base  text-[#6A6A6A]">+91 01928 20392</p>
              </div>
              ...
              <div className="w-full flex flex-col  ">
                ...
                <p className="text-base  text-[#6A6A6A]">150 Employees</p>
              </div>
            </div>
            <div className=" md:pl-6 font-normal md:w-1/2 h-full  flex flex-col gap-1 ">
              ...
              <div className="w-full flex flex-col  ">
                ...
                <p className="text-base  text-[#6A6A6A]">Ecommerce</p>
              </div>
              ...
              <div className="w-full flex flex-col  ">
                ...
                <p className="text-base  text-[#6A6A6A]">03 February, 2024</p>
              </div>

              <div className="w-full flex flex-col  ">
                <h2 className="text-lg  text-[#344054]">Maintenance Needed</h2>
                <p className="text-base  text-[#6A6A6A]">Yes</p>
              </div>
